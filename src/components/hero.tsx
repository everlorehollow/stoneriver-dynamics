        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#133963] font-semibold tracking-wide uppercase text-sm hover:bg-[#f5f5f7] transition-colors"
            >
              {config.cta.label}
            </Link>
            {config.secondaryCta && (
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-white/40 text-white font-semibold tracking-wide uppercase text-sm hover:bg-white/10 transition-colors"
              >
